...
import { verifySeller } from "../middlewares/verifyRole.middleware.js"
...
router.route("/addProduct").post(
    ...
    upload.fields([{ name: "productImage", maxCount: 1 }]), // Handle file upload
...
router.route("/getProductsByCategoryId/:category").get(verifyJWT, getProductsByCategoryId);
